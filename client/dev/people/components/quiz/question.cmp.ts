...
export class QuestionComponent {
  ...
  static QUIZ_DELAY: number = localStorage && !isNaN(parseInt(localStorage.getItem('QUIZ_DELAY'))) || 2000;
  static QUIZ_DELAY_INCORRECT: number = localStorage && !isNaN(parseInt(localStorage.getItem('QUIZ_DELAY'))) || 3000;
